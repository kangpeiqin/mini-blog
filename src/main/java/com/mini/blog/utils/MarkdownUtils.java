...
public class MarkdownUtils {
    ...
    public static String renderHtml(String markdown) {
        ...
        if (markdown.contains(CommonConstant.NETEASE_MUSIC_PREFIX)) {
            markdown = markdown.replaceAll(CommonConstant.NETEASE_MUSIC_REG_PATTERN, CommonConstant.NETEASE_MUSIC_IFRAME);
        }

        // Render bilibili video short url.
        if (markdown.contains(CommonConstant.BILIBILI_VIDEO_PREFIX)) {
            markdown = markdown.replaceAll(CommonConstant.BILIBILI_VIDEO_REG_PATTERN, CommonConstant.BILIBILI_VIDEO_IFRAME);
        }

        // Render youtube video short url.
        if (markdown.contains(CommonConstant.YOUTUBE_VIDEO_PREFIX)) {
            markdown = markdown.replaceAll(CommonConstant.YOUTUBE_VIDEO_REG_PATTERN, CommonConstant.YOUTUBE_VIDEO_IFRAME);
        }
